...
helm upgrade ingress-nginx ingress-nginx/ingress-nginx --version 4.12.3 --values ../nginx-values.yaml -n ingress-nginx
helm upgrade mongodb bitnami/mongodb --version 16.5.20 --values ../mongodb-values.yaml -n infrastructure
helm upgrade postgresql bitnami/postgresql --version 16.7.10 --values ../postgresql-values.yaml -n infrastructure
helm upgrade rabbitmq bitnami/rabbitmq --version 16.0.6 --values ../rabbitmq-values.yaml -n infrastructure
